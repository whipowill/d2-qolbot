...
MainLoop:
    while (true) {
        if (player) {
            ...
            //stops helpers helping in throne or chaos!!
            // Finish if leader is in chaos or throne
            //dhdif ([108, 131].indexOf(player.area) > -1) {
            //dhd   break;
            //dhd}
            ...
            if (command !== oldCommand) {
                ...
                if (command.indexOf("kill") > -1) {
                    ...
                    if (me.area === player.area) {  //dhd me.area === area
